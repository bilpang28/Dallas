				...
				<ul class="metismenu" id="menu">
					<li>
						...
						<ul>
							...
							<li> <a href="{{ url('dashboard-digital-marketing') }}"><i class="bx bx-right-arrow-alt"></i>Digital Marketing</a>
							</li>
							<li> <a href="{{ url('dashboard-human-resources') }}"><i class="bx bx-right-arrow-alt"></i>Human Resources</a>
							</li>
						</ul>
					</li>
					<li>
